  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "ashutoshgola91@gmail.com",
      href: "mailto:ashutoshgola91@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6" />,
      title: "Phone",
      value: "+91 7895527454",
      href: "tel:+917895527454",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/Ashutoshgola",
      label: "GitHub",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      href: "https://www.linkedin.com/in/ashutoshgola91/",
      label: "LinkedIn",
    },
    {
      icon: <TwitterIcon className="h-5 w-5" />,
      href: "https://x.com/AshutoshGola1",
      label: "Twitter",
    },
  ];
